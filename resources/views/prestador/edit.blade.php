    ...
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('prestador.store') }}">
            ...
            <div>
                ...
                <x-input id="nome" class="block mt-1 w-full" type="text" name="nome" :value="old('nome', $prestador->nome)" required autofocus />
            </div>
            ...
            <div class="mt-4">
                ...
                <x-input id="cpf" class="block mt-1 w-full" type="number" name="cpf" :value="old('cpf', $prestador->cpf)" required  />
            </div>
